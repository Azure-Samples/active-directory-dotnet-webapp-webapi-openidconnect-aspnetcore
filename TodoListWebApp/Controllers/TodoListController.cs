    ...
    public class TodoListController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                ...
                HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Get, Startup.TodoListBaseAddress + "/api/todolist");
        ...
        public async Task<ActionResult> Index(string item)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    //
                    HttpClient client = new HttpClient();
                    HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Post, Startup.TodoListBaseAddress + "/api/todolist");
                    request.Headers.Authorization = new AuthenticationHeaderValue("Bearer", result.AccessToken);
