...
#> 
   ...
   Write-Host "Creating the AAD application (TodoListService-aspnetcore)"
   $serviceAadApplication = New-AzureADApplication -DisplayName "TodoListService-aspnetcore" `
   ...
   Write-Host "Done creating the service application (TodoListService-aspnetcore)"
   ...
   Add-Content -Value "<tr><td>service</td><td>$currentAppId</td><td><a href='$servicePortalUrl'>TodoListService-aspnetcore</a></td></tr>" -Path createdApps.html
   ...
   Write-Host "Creating the AAD application (TodoListWebApp-aspnetcore)"
   # Get a 2 years application key for the client Application
   $pw = ComputePassword
   $fromDate = [DateTime]::Now;
   $key = CreateAppKey -fromDate $fromDate -durationInYears 2 -pw $pw
   $clientAppKey = $pw
   $clientAadApplication = New-AzureADApplication -DisplayName "TodoListWebApp-aspnetcore" `
   ...
   Write-Host "Done creating the client application (TodoListWebApp-aspnetcore)"

   # URL of the AAD application in the Azure portal
   # Future? $clientPortalUrl = "https://portal.azure.com/#@"+$tenantName+"/blade/Microsoft_AAD_RegisteredApps/ApplicationMenuBlade/Overview/appId/"+$clientAadApplication.AppId+"/objectId/"+$clientAadApplication.ObjectId+"/isMSAApp/"
   $clientPortalUrl = "https://portal.azure.com/#blade/Microsoft_AAD_RegisteredApps/ApplicationMenuBlade/CallAnAPI/appId/"+$clientAadApplication.AppId+"/objectId/"+$clientAadApplication.ObjectId+"/isMSAApp/"
   Add-Content -Value "<tr><td>client</td><td>$currentAppId</td><td><a href='$clientPortalUrl'>TodoListWebApp-aspnetcore</a></td></tr>" -Path createdApps.html
   ...
   $requiredPermissions = GetRequiredPermissions -applicationDisplayName "TodoListService-aspnetcore" `
